package com.localization.myapp.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterSampleLocalizedDtoApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterSampleLocalizedDtoApp");
        ...
        config.getMapConfigs().put("com.localization.myapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
